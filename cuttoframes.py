...
differencelevel = 60 # the level of threshold of difference between consequent frames
...
# promtp the mode of dissection "unique frames" or "fixed totla number of frames"
